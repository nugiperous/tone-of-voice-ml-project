...
#function used to fine-tune frequency identifier function
...
def wav_to_highest_volume_frequency(wav_file, interval=.2):
...
for filename in os.listdir(wav_file_dir):
    if filename.endswith(".wav"):
        ...
        if "ques" in filename or "rhet" in filename:
            file_type = "question"
        elif "stmt" in filename or "sarc" in filename:
            file_type = "statement"
        else:
...
print("Support Vector Machine Classifier Using .15s as Interval Length:")
